...
<head>
    ...
    <style>
      ...
      <?php include 'C:\xampp\htdocs\onlineleavemanagemet\hod\hod_status.css'; ?>
    </style>
...
$selectquery = "select $no,leave_type,duration,from_date,to_date,reason,status from hod_applied_leave where email='$email'";
