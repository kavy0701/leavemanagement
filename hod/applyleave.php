...
$sql="select name,email,course from user_register where email='$email'";
...
if(isset($_POST['submit'])){
  ...
  $insertquery = "insert into hod_applied_leave(name,email,course,leave_type,duration,from_date,to_date,reason) values('$name','$email','$course','$leave_type','$duration','$from_date','$to_date','$reason') ";
...
<head>
    ...
    <style>
      ...
      <?php include 'C:\xampp\htdocs\onlineleavemanagemet\hod\hod_applyleave.css';?>
    </style>
...
<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
    ...
    <div class="form-label-group">
        <label for="course">Course</label> <input type="text" name="course" id="course" class="form-control" required autocomplete="off" value="<?php echo $course ?>" readonly>
    </div>
    <br>
