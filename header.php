...
<div id="mySidenav" class="sidenav">
  ...
  <a href="profile.php"><i class="fas fa-users"></i>Profile</a>
  <a href="applyleave.php"><i class="fas fa-calendar-plus"></i>Apply leave</a>
  <a href="status.php"><i class="fas fa-check"></i>Status</a>
